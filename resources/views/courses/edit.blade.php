...
<a href="{{ route('courses.show', $course) }}" class="text-sm text-gray-500 hover:text-gray-800">&larr; Back to course</a>

<h1 class="mt-6 text-2xl font-semibold tracking-tight">Edit &ldquo;{{ $course->title }}&rdquo;</h1>
    ...
    <div class="space-y-5">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4" required
                      class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $course->description) }}</textarea>
        </div>
    </div>
